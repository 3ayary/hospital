  ...
  return (
    <div className="relative w-fit h-fit ">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white">
        ...
        <form className="mt-4 flex h-13 bg-white text-black rounded-xl">
         <div className="flex items-center gap-2 p-2">
          ...
          <button className="bg-blue-400 flex h-7 self-center font-semibold text-md mr-1 p-5 rounded-xl items-center ml-1  hover:bg-blue-300">Search</button>
        </form>
      </div>
    </div>
  );
